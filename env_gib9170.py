...
class CatAndMouseEnv(gym.Env):
    def __init__(self, grid_size=10):
        ...
        self.goal_state = np.array([self.grid_size - 1, self.grid_size - 1])
    ...
    def step(self, action):
        ...
        if any(np.array_equal(self.mouse_state, cat_state) for cat_state in self.cat_states):
            ...
            reward = -100
        elif np.array_equal(self.mouse_state, self.goal_state):
            done = True
            reward = 100
    ...
    def render(self):
        ...
        self.screen.blit(self.goal_image, (self.goal_state[0] * self.square_size, self.goal_state[1] * self.square_size))
