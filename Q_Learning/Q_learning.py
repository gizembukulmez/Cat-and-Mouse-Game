...
# Simple test heatmap
test_data = np.random.rand(11, 11)
sns.heatmap(test_data, annot=True, fmt=".2f", cmap="viridis")
plt.show()
...
# -----------
def visualize_q_table(cat_states=[(3, 3), (6, 6), (8, 8)],
    ...
    try:
        ...
        for i, action in enumerate(actions):
            ...
            mask[cat_states[0]] = True
            mask[cat_states[1]] = True
            ...
            ax.text(cat_states[0][1] + 0.5, cat_states[0][0] + 0.5, 'H', color='red',
                    ha='center', va='center', weight='bold', fontsize=14)
            ax.text(cat_states[1][1] + 0.5, cat_states[1][0] + 0.5, 'H', color='red',
                    ha='center', va='center', weight='bold', fontsize=14)
